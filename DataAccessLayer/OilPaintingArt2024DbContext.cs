...
public partial class OilPaintingArt2024DbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.OilPaintingArtId).HasName("PK__OilPaint__708184D8616CF3BB");
        ...
        {
            entity.HasKey(e => e.SupplierId).HasName("PK__Supplier__4BE666B4FBE02919");
        ...
        {
            entity.HasKey(e => e.AccountId).HasName("PK__SystemAc__349DA586271AFA3C");

            entity.ToTable("SystemAccount");

            entity.HasIndex(e => e.AccountEmail, "UQ__SystemAc__FC770D33362A0766").IsUnique();
